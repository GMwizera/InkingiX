...
/**
 * InkingiX Rwanda - Student Dashboard (My Journey)
...
// Set page greeting
$pageGreeting = __('dashboard_welcome', 'Welcome back') . ', ' . htmlspecialchars($currentUser['first_name']) . '!';
$pageSubtitle = __('dashboard_subtitle', 'Track your career discovery progress');
